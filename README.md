...
Support and security reports go through the issue tracker only (SUPPORT.md): https://git.cubealgos.de/cubealgos/create_brass_compass/issues.

Source: https://git.cubealgos.de/cubealgos/create_brass_compass (Forgejo, the home of this repository). Mirror: https://github.com/cubealgos/create_brass_compass, read-only, issues off.
