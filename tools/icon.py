#!/usr/bin/env python3
"""Render docs/modrinth/icon.png: the brass compass on the round blueprint badge Create's add-ons share.

The palette is sampled from Create's own Modrinth icon: outer band, pale ring, blueprint blue, white
grid at half alpha. The sprite is frame 00 of the needle, scaled without smoothing, with a one-pixel
white outline and a soft shadow. Requires Pillow.
"""
