// Create Fly: Brass Compass — one Gradle project, one jar (docs/spec/04-architecture.md ARCH-DEC-001).
plugins {
    java
...
// The pure package: brass_compass.destinations has no Minecraft imports (docs/spec/operations/testing.md TEST-REQ-002).
val verifyPurePackage by tasks.registering {
    group = "verification"
    description = "Fails when brass_compass.destinations imports Minecraft, Fabric or Create."
    val sources = layout.projectDirectory.dir("src/main/java/brass_compass/destinations")
    inputs.dir(sources)
    doLast {
